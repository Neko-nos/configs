...
`install/install.sh` runs all the install scripts including those in the `common/install` directory. Git, nano, Codex, Claude Code, Python, and markdownlint setups are optional and prompted interactively.

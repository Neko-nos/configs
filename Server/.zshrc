# copied from common/zsh/.zshrc
# just added spack loading
...
typeset -g _common_functions_dir="${CONFIGS_COMMON_ZSH}/functions"
...
function __load_spack() {
    ...
    [[ -r "${spack_root}/share/spack/setup-env.sh" ]] || return
    source "${spack_root}/share/spack/setup-env.sh"

    local cache_dir="${XDG_CACHE_HOME:-$HOME/.cache}/spack"
    local architecture_cache="${cache_dir}/architecture-${HOST}"
